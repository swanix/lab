...
class AppRouter {
  ...
  cleanupXDiagramsElements() {
    try {
      ...
      // Remover clase de ocultación del title pill
      document.body.classList.remove('xdiagrams-hide-title-pill');
      console.log('[AppRouter] Clase xdiagrams-hide-title-pill removida del body');
